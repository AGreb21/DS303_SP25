...
**My favorite fruit is apples, but i could never have them growing up cause my dad was allergic.**
...
Evaluate the below plots. Do they align with the model interpretation above? Yes they do
...
based on the graphs made the lm.price model shows that there is not very much difference in price based on shelve location, and that no matter the good, medium or bad shelf they are all very similar priced
...
The lm.carseats model shows variables and their affects on sales. The variables with stars on the right are the ones that have significant impact on sales, those being; CompPrice, Income, Advertising, Price, ShelveLocGood, and Age
...
this type of model can be used for companies to decide what factors they put more time money and effort into in order to increase sales by the most possible.
