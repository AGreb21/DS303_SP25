...
-   for each one-unit increase in petal length
...
-   **(Intercept)**: -21.126
    ...
    -   This is the log-odds of being classified as "versicolor" when the petal width is zero.

-   **your predictor**: 12.947

    -   This coefficient represents for each one unit in petal width the log odds of being classified as verginica increase by e\^12.947.
