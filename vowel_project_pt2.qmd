...
-   linear regression: For when your outcome variable is numeric. eg. duration

-   logistic regression: For when your outcome variable is categorical and binary

-   mixed effects models (linear or logistic): For when you want to include random effects
