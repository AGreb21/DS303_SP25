...
# Added in the 'Boston <-' to assign the data set so we can access it from the environment as we please
...
The model is telling me that my y intercept or b0 value is 12.5583, and my slope or b1 value is -2.448
